...
function Homescreen() {
  ...
  return (
    <div className="mt-5 dateBg" >
      <div className="container">
        <div className="row bs p-3 m-5 test">
          ...
          <div className="col-md-4 ">
            ...
            <option value="all">All</option>
              <option value="delux">Luxury </option>
              <option value="non-delux">Economical </option>
      ...
      <div className="row justify-content-center ">
        {loading ? (
          ...
          hotels.map((room) => {
            return (
              <div className="col-md-8 test" data-aos='zoom-in'>
