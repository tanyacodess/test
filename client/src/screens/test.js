...
export const MyOrders = () => {
  ...
  const getRefundPercentage = (createdAt) => {
    ...
    <div>
      ...
      <div className="col-md-6 my-auto">
        <div className="bs m-1 p-2">
          ...
          {booking.status === "booked" && (
            <div className="text-right">
              {booking.fromdate - Date.now() > 48 * 60 * 60 * 1000 ? (
                <p>You will get a full refund.</p>
              ) : booking.fromdate - Date.now() > 24 * 60 * 60 * 1000 ? (
                <p>You will get a 50% refund.</p>
              ) : (
